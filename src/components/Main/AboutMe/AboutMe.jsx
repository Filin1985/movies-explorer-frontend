        ...
        <section className='profile' ref={scroll}>
            ...
            <article className='profile__card'>
                <div className='profile__info' >
                    ...
                    <p className='profile__text'>Я живу в Москве. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. &shy;С 2017 года работал в компании Роснефть. Сейчас работаю в банке Дом.РФ.</p>
